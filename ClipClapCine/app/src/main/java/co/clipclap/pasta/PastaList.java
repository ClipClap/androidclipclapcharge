...
import co.clipclap.pasta.adapters.PastaAdapter;
import co.clipclap.pasta.objects.Movie;
import co.clipclap.pasta.objects.RecyclerItemClickListener;
import co.clipclap.pasta.objects.RoundingTextsView;

public class PastaList extends AppCompatActivity {
...
//                        Intent intent = new Intent(self,PastaDetail.class);
//                        Bundle b = new Bundle();
//                        b.putParcelableArrayList(PastaDetail.DATA, items);
//                        b.putInt(PastaDetail.CURRENT_POSITION, position);
//                        intent.putExtras(b);
//                        startActivity(intent);

                        Intent intent = new Intent(self,PastaPriceDetail.class);
                        Bundle b = new Bundle();
                        b.putParcelableArrayList(PastaDetail.DATA, items);
                        b.putInt(PastaDetail.CURRENT_POSITION, position);
...
// Crear un nuevo adaptador
        adapter = new PastaAdapter(items);
        recycler.setAdapter(adapter);
        configureBarWithoutBack("Restaurante ClipClap",this);
    }
